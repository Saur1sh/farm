...
?>
        ...
        <!-- Main Content -->
        <div class="hk-pg-wrapper" style="background-color: bisque;">
            <!-- Breadcrumb -->
    ...
    foreach ($_SESSION["cart_item"] as $item){
        ...
        ?>
           <input type="hidden" value="<?php echo $item['quantity']; ?>" name="quantity[<?php echo $item['code']; ?>]">
                ...
                <td><a href="search-product.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="dist/img/icon-delete.png" alt="Remove Item" width="40" height="40"/></a></td>
                </tr>
                <?php
