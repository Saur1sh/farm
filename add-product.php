...
<div class="form-row">
<div class="col-md-6 mb-10">
<label for="validationCustom03">Stock Available</label>
<input type="number" class="form-control" id="validationCustom03" placeholder="Stock Left..." name="productStock" required>
